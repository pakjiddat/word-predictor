...
The wordpredictor package is based on R6 classes. It is easy to customize and improve.
...
The output file **def-model.RDS** is placed in the **./tests/testthat/data/model** folder. It represents the n-gram model.
