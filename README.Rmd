...
[![Test Coverage](https://github.com/pakjiddat/word-predictor/workflows/test-coverage.yaml/badge.svg)](https://github.com/pakjiddat/word-predictor/actions/workflows/test-coverage.yaml)
...
9. **Base**. The base class for all the other classes. It allows provides methods for reading and writing files and processing large text files. 
